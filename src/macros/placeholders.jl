...
"""
Placeholder macro declarations for IDE/completion/doc purposes.

Real behavior is implemented by top-level command macro expansion.
All placeholders return `nothing` at runtime.
"""
